      ...
      <div className="deal-items">
        {AllProducts &&
          AllProducts.map((items) => {
            ...
            const priceInINR = (items.price * conversionRate).toFixed(2);
            const mrpInINR = (Math.round(items.price * 1.66 * conversionRate)).toFixed(2);
              ...
              <div className="card" key={items.id}>
                ...
                <div className="card-data">
                  ...
                  <div className="card-price">
                    <p className="discount">₹{priceInINR}</p>
                    <p className="mrp">₹{mrpInINR}</p>
